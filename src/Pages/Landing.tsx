  ...
  return (
    <div className="min-h-dvh bg-amber-800/85 text-white relative">
        <div className="flex flex-col relative top-20 justify-center items-center gap-y-4">
          ...
          <div>
            {session==null?<button onClick={handleSignin} className="bg-white text-black flex flex-row items-center px-6 py-3 gap-x-3 rounded-full hover:text-white hover:bg-blue-400 hover:cursor-pointer">
            <div>
